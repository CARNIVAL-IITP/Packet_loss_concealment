...
class PLCModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        TAPLoss = AcousticLoss('frame_energy_weighted_l1',"/home/dh/Workspace/TAPLoss/TAPLoss/TAP_estimator_model_v0.pt", False, None,
                               device='cuda')
        TAP_loss = TAPLoss(y_TAP, x_TAP, 'train') # clean, enh, mode (train or eval)
        loss = self.loss(x,y) + 1*TAP_loss
    ...
    def validation_step(self, val_batch, batch_idx):
        ...
        loss = FRN_loss + 1*TAP_loss # 0.3TAP
        #### add for TAPLoss: end
